...
*   Description : omx_videodec_component.h
...
typedef struct _VIDEO_DECOD_INSTANCE_ {
	...
	queue_t *pVPUDisplayedClearQueue;
	...
	OMX_CONFIG_RECTTYPE rectCropParm;
	...
	OMX_U32 nDisplayedFirstFrame;
	OMX_U32 nDisplayedLastFrame;
	...
	OMX_U32 nDelayedOutputBufferCount;
	OMX_U32 nSkipOutputBufferCount;
	OMX_S32 nPlaySpeed;
...
OMX_ERRORTYPE dxb_omx_videodec_component_Init(OMX_COMPONENTTYPE *openmaxStandComp);
...
OMX_ERRORTYPE dxb_omx_videodec_component_MessageHandler(OMX_COMPONENTTYPE*,internalRequestMessageType*);
...
void dxb_omx_videodec_component_BufferMgmtCallback(
  OMX_COMPONENTTYPE *openmaxStandComp,
  OMX_BUFFERHEADERTYPE* inputbuffer,
  OMX_BUFFERHEADERTYPE* outputbuffer);

OMX_ERRORTYPE dxb_omx_videodec_component_GetParameter(
  OMX_IN  OMX_HANDLETYPE hComponent,
  OMX_IN  OMX_INDEXTYPE nParamIndex,
  OMX_INOUT OMX_PTR ComponentParameterStructure);

OMX_ERRORTYPE dxb_omx_videodec_component_SetParameter(
  OMX_IN  OMX_HANDLETYPE hComponent,
  OMX_IN  OMX_INDEXTYPE nParamIndex,
  OMX_IN  OMX_PTR ComponentParameterStructure);

OMX_ERRORTYPE dxb_omx_videodec_component_ComponentRoleEnum(
  OMX_IN OMX_HANDLETYPE hComponent,
  OMX_OUT OMX_U8 *cRole,
  OMX_IN OMX_U32 nIndex);

OMX_ERRORTYPE dxb_omx_videodec_component_SetConfig(
  OMX_HANDLETYPE hComponent,
  OMX_INDEXTYPE nIndex,
  OMX_PTR pComponentConfigStructure);

OMX_ERRORTYPE dxb_omx_videodec_component_GetExtensionIndex(
  OMX_IN  OMX_HANDLETYPE hComponent,
