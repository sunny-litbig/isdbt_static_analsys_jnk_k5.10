...
#define GPIO_NUM_RF_SWITCHING_TCC3532_SINGLE	10
#define GPIO_NUM_RF_SWITCHING_TCC3531_MASTER	8
#define GPIO_NUM_RF_SWITCHING_TCC3531_SLAVE	19
#define GPIO_NUM_RF_SWITCHING_TCC3531_SLAVE_2_X 2
#define GPIO_NUM_RF_SWITCHING_TCC3531_SLAVE_3_X 3
...
#define GPIO_NUM_TRIPLE_BAND_RF_SWITCHING_SLAVE1	17
#define GPIO_NUM_TRIPLE_BAND_RF_SWITCHING_SLAVE2	18
#define GPIO_NUM_TRIPLE_BAND_RF_SWITCHING_SLAVE3	19
...
typedef enum {
	...
	BB_TCC3536		/* 4.4BD - Support FullSeg */
} EnumTcc353xBaseBandName;

typedef enum {
	VER_TCC353X_DONT_CARE = 0,
