...
#define MAX_DIV_PARAM_RSSI	15
typedef struct {
	I32S rssi[TCC353X_DIVERSITY_MAX];
	I32S rssi_avgArray[TCC353X_DIVERSITY_MAX][MAX_DIV_PARAM_RSSI];
	I32U rssiCount;
	TcpalTime_t oldAccessTime;
} Tcc353xDivProc_Params;
