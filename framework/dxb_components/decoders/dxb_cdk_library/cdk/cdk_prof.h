...
{\
	...
	clock_gettime(CLOCK_MONOTONIC , &_tspec);\
	glProfStartTime[idx] = ((long long)_tspec.tv_sec)*1000000 + ((long long)_tspec.tv_nsec);\
}
...
{\
	struct timespec _tspec;\
	clock_gettime(CLOCK_MONOTONIC , &_tspec);\
	glProfEndTime[idx] = ((long long)_tspec.tv_sec)*1000000 + ((long long)_tspec.tv_nsec/1000);\
