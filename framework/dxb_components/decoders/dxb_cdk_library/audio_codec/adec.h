...
typedef enum AAC_CHANNELTYPE {
    CHANNEL_TYPE_NONE = 0x0,    /**< Unused or empty */
    CHANNEL_TYPE_LF   = 0x1,    /**< Left front */
    CHANNEL_TYPE_RF   = 0x2,    /**< Right front */
    CHANNEL_TYPE_CF   = 0x3,    /**< Center front */
    CHANNEL_TYPE_LS   = 0x4,    /**< Left surround */
    CHANNEL_TYPE_RS   = 0x5,    /**< Right surround */
    CHANNEL_TYPE_LFE  = 0x6,    /**< Low frequency effects */
    CHANNEL_TYPE_CS   = 0x7,    /**< Back surround (back center) */
    CHANNEL_TYPE_LR   = 0x8,    /**< Left rear. */
    CHANNEL_TYPE_RR   = 0x9,    /**< Right rear. */
    CHANNEL_TYPE_MAX  = 0x7FFFFFFF 
} AAC_CHANNELTYPE;
...
{	
	...
	struct 
	{
		...
		//!		MatrixMixdown Mode: 0 = disable (default), 1 = ISO/IEC 14496-3, 2 = ARIB STD-B21 Version 5.3, 3 = ARIB STD-B21 Version 4.6
		int		m_uiMatrixMixDownMode;
		//!		MatrixMixdown External pseudo-surround processor: 0 = disable (default, use Set1 (Table 6-DM1) ), 1 = enable (use Set2 (Table 6-DM2))
		//!   Used only when m_uiMatrixMixDownMode != 0
		int		m_uiUseExternalPseudoSurround;
		//!		RESERVED
		int		reserved[32-13];
	} m_unAAC;
