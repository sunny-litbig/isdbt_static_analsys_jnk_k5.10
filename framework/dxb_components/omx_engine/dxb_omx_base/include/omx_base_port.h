...
#define PORT_IS_BEING_CHANGED(pPort)														 (pPort->bIsPortChanged == OMX_TRUE)
...
#define omx_base_PortType_FIELDS \
  ...
  OMX_BOOL bIsPortChanged;/**< @param bIsPortChanged Boolean variables indicate port is being changed at the moment */ \
  ...
  OMX_ERRORTYPE (*Port_AllocateBuffer2)(omx_base_PortType *openmaxStandPort,OMX_INOUT OMX_BUFFERHEADERTYPE** pBuffer,OMX_IN OMX_U32 nPortIndex,OMX_IN OMX_PTR pAppPrivate,OMX_IN OMX_U32 nSizeBytes);/**< Replaces the AllocateBuffer call for the base port. */   \
  OMX_ERRORTYPE (*Port_UseBuffer2)(omx_base_PortType *openmaxStandPort,OMX_BUFFERHEADERTYPE** ppBufferHdr,OMX_U32 nPortIndex,OMX_PTR pAppPrivate,OMX_U32 nSizeBytes,OMX_U8* pBuffer);/**< The standard use buffer function applied to the port class */ \
  OMX_ERRORTYPE (*Port_FreeBuffer2)(omx_base_PortType *openmaxStandPort,OMX_U32 nPortIndex,OMX_BUFFERHEADERTYPE* pBuffer); /**< The standard free buffer function applied to the port class */
...
OMX_ERRORTYPE dxb_base_port_ReturnBufferFunction(
  omx_base_PortType* openmaxStandPort,
  OMX_BUFFERHEADERTYPE* pBuffer);
...
OMX_ERRORTYPE dxb_base_port_ComponentTunnelRequest(
  omx_base_PortType* openmaxStandPort,
 ...
 */
OMX_ERRORTYPE dxb_base_port_AllocateTunnelBuffer(
  omx_base_PortType *openmaxStandPort,
 ...
 */
OMX_ERRORTYPE dxb_base_port_FreeTunnelBuffer(
  omx_base_PortType *openmaxStandPort,
  OMX_U32 nPortIndex);
