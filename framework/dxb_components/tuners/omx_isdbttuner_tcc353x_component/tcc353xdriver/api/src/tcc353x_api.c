...
extern I32S Tcc353xDiversityUnlockEnforce(I32S _moduleIndex, 
					  I32S _diversityIndex, 
				          I32S _diversityUnlockEnforcement);
extern I32S Tcc353xCheckTcc3531Version(I32S _moduleIndex);
 ...
 * Return value
 *      return < 0 : Fail (Refer) EnumReturn
 *      others : TCC353X chip version info (EnumTcc3531Version)
 * Remark
		    ...
		    I32S _optionSize)
{
	...
	if (_optionSize > TCC353X_DIVERSITY_MAX * sizeof(Tcc353xOption_t)) {
		...
		if (needNumberofOptions != _optionSize) {
			...
			ret = Tcc353xCheckTcc3531Version(_moduleIndex);
		}
	}
	return ret;
}
			     ...
			     Tcc353xTuneOptions * _tuneOption)
{
	...
	memset(&inputOption, 0, sizeof(Tcc353xTuneOptions));
...
/*---------------------------------------------------------------------
 * Function name
 * 	Tcc353xApiDiversityCombineBlock
 * Description
 * 	
 * Parameters
 * 	_moduleIndex : Index of module
 ...
 * 	
 ---------------------------------------------------------------------*/
I32S Tcc353xApiDiversityCombineBlock(I32S _moduleIndex, I32S _diversityIndex, 
			   I32S _diversityUnlockEnforcement)
{
	I32S ret = TCC353X_RETURN_SUCCESS;
	...
	if (Tcc353xApiCheckConditions(_moduleIndex) !=
		...
		Tcc353xDiversityUnlockEnforce(_moduleIndex, _diversityIndex, 
					   _diversityUnlockEnforcement);
	}
	return ret;
}
