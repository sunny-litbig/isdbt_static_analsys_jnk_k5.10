...
*   Description : omx_base_component.h
...
#define DEFAULT_IN_BUFFER_SIZE  		(202*1024)
#define DEFAULT_OUT_BUFFER_SIZE 		(3200*1024)
#define	VIDEO_DEC_OUT_BUFFER_SIZE		(1024*1024)
#define VIDEO_DEC_IN_BUFFER_SIZE 		(1024*1024)

#define	AUDIO_DEC_OUT_BUFFER_SIZE		1024*1024
#define	AUDIO_DEC_IN_BUFFER_SIZE		1024*1024

/*For DxB We have to define another BUFFER_SIZE, because BUFFER_ZIE can be changed in PV Player.
* This make a trobule at every update.
*/
#define	AUDIO_DXB_OUT_BUFFER_SIZE		(3200*1024)
#define	AUDIO_DXB_IN_BUFFER_SIZE		1024*1024

#define	VIDEO_DXB_OUT_BUFFER_SIZE		1024*1024
#define	VIDEO_DXB_IN_BUFFER_SIZE		1024*1024

#define	DEFAULT_DXB_OUT_BUFFER_SIZE		1024*1024
#define	DEFAULT_DXB_IN_BUFFER_SIZE		1024*1024
...
typedef enum OMX_INDEXVENDORTYPE {
  ...
  OMX_IndexVendorParserInputFilename = 0xFF000002,
...
#define omx_base_component_PrivateType_FIELDS \
  ...
  tsem_t* bStateSem;/**< @param bMgmtSem the semaphore that control BufferMgmtFunction processing */\
 	tsem_t* bPortChangeSem;/**< @param bPortChangeSem the semaphore that control PortChange processing */\
 ...
 */
OMX_ERRORTYPE dxb_omx_base_component_DoStateSet(
 ...
 */
void* dxb_compMessageHandlerFunction(void*);
 ...
 */
OMX_ERRORTYPE dxb_omx_base_component_ParameterSanityCheck(
            OMX_IN  OMX_HANDLETYPE hComponent,
...
#define COMPONENT_NAME(comp_handle) (((omx_base_component_PrivateType *)(OMX_COMPONENTTYPE *)comp_handle->pComponentPrivate)->name)
